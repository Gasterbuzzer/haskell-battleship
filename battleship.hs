  ...
  ListFrame $
    map
      ( \y ->
          map
            (\x ->
              if x == x' && y == y' && a' == 0 then Pixel 0x00 0x00 0xff
              else if x == x' && y == y' && a' == 1 then Pixel 0xff 0x00 0x00
              else if x == x' && y == y' && a' == 2 then Pixel 0xff 0xff 0xff else Pixel 0 0 0)
            [0 .. xdim - 1]
      )
      [0 .. ydim - 1]
