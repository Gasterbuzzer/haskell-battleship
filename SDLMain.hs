...
initState = (10, 1, 3, 1, 0) -- For Info see type above.
...
toFrameList (xdim, ydim) pixels (xC, yC, cursorColor, cursorMode, frameMode) = case frameMode of
  ...
  1 -> toFrame dim (xC, yC, cursorColor, cursorMode, frameMode)
